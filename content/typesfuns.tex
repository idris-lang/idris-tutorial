...
\noindent
For more details of the functions available on \texttt{List} and \texttt{Vect}, look in the library, in \texttt{libs/prelude/list.idr} and \texttt{libs/prelude/vect.idr} respectively.
