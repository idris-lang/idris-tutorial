...
\inputIdrisListing[firstline=2,lastline=7]{./examples/usefultypes.idr}
...
\noindent
For more details of the functions available on \texttt{List} and \texttt{Vect}, look in the library, in \texttt{libs/prelude/Pre\-lude/List.idr} and \texttt{libs/prelude/Prelude/Vect.idr} respectively.
